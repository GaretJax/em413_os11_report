...
\ref{tbl:decisions} presents the set of candidate architectural decisions identified for the satellite system under study. Each decision represents a technical choice within the system developer’s control, within the system boundary, and materially influences the system's structure or behavior. For each architectural decision, a discrete set of mutually exclusive options is defined, representing alternative ways the system could be architected.
